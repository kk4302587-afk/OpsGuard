...
import { Input, Button, Card, Tag, Space, Typography, List, Divider } from 'antd'
import {
  SafetyOutlined,
  BugOutlined,
  CheckCircleOutlined,
...
function SecurityDemo() {
  ...
  return (
    <div style={{ padding: 24, height: '100%', overflow: 'auto' }}>
      ...
      {/* Example attacks */}
      {examples && (
        <Card size="small" title={<><BugOutlined style={{ marginRight: 6 }} />预设攻击样本</>} style={{ marginBottom: 16, background: 'var(--bg-secondary)', border: '1px solid var(--border-color)' }}>
